...
# from apps.meli import ApiClient, ApiTypeError, ApiValueError
from apps.meli.api_client import ApiClient
from apps.meli.exceptions import ApiValueError
from apps.meli.exceptions import ApiTypeError
...
class RestClientApi(object):
    ...
    def resource_delete_with_http_info(self, resource, access_token, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('resource' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError(
                "Missing the required parameter `resource` when calling `resource_delete`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('access_token' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError(
                "Missing the required parameter `access_token` when calling `resource_delete`")  # noqa: E501
    ...
    def resource_get_with_http_info(self, resource, access_token, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('access_token' not in local_var_params or  # noqa: E501
                                                       local_var_params['access_token'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `access_token` when calling `resource_get`")  # noqa: E501
    ...
    def resource_get_file(self, resource, access_token, **kwargs):  # noqa: E501
        """Resource path GET  # noqa: E501
        ...
        return self.api_client.call_api_file(
            '/{resource}', 'GET',
            path_params,
            query_params,
            header_params,
    ...
    def resource_post_with_http_info(self, resource, access_token, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('access_token' not in local_var_params or  # noqa: E501
                                                       local_var_params['access_token'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `access_token` when calling `resource_post`")  # noqa: E501
    ...
    def resource_put_with_http_info(self, resource, access_token, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('access_token' not in local_var_params or  # noqa: E501
                                                       local_var_params['access_token'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `access_token` when calling `resource_put`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
                                                       local_var_params['body'] is None):  # noqa: E501
